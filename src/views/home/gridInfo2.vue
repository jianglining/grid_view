  ...
  <q-splitter v-model="splitterModel" style="height: 90vh">
    ...
    <template v-slot:before>
      <q-card bg-grey-6>
        ...
        <q-card-section style="height: 730px;">
          <q-tree
            :nodes="simple"
            node-key="grid_bm"
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'scenefile', label: '网格场景图名称', align: 'center', field: 'scenefile' },
        { name: 'is_scenefile', label: '是否已上传场景图', align: 'center', field: 'is_scenefile' },
        {
          name: 'cz',
          align: 'center',
          label: '操作',
